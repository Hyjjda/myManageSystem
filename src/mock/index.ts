...
Mock.mock('https://www.demo.com/login', 'post', (options: any) => {
  ...
  } else if (username === 'user' && password === '999999') {
    return {
      code: 200,
      msg: '登陆成功',
      data: {
        token: 'user999user999',
        user: {
          nickname: '用户',
          roles: ['user'],
        },
...
//echart数据 line
Mock.mock('https://www.demo.com/lineData', 'get', () => {
  return {
    code: 200,
    msg: '获取数据成功',
    data: {
      list: [
        ...
        { name: '充电时间', data: [40, 60, 50, 80, 70, 90, 60, 70, 80] },
...
//echart数据 pie
Mock.mock('https://www.demo.com/pieData', 'get', () => {
  return {
    code: 200,
    msg: '获取数据成功',
    data: {
...
// echart数据 radio
Mock.mock('https://www.demo.com/radioData', 'get', () => {
  return {
    code: 200,
    msg: '获取数据成功',
    data: {
...
Mock.mock('https://www.demo.com/crossData', 'get', () => {
  return {
    code: 200,
    msg: '获取成功',
    data: {
      list1: [3, 6, 9, 10, 12, 3, 5, 10, 25, 30, 20, 10],
      list2: [10, 16, 19, 26, 12, 43, 35, 30, 22, 33, 20, 11],
    },
  }
})
//充电站相关
...
//新增或修改数据
Mock.mock('https://www.demo.com/station/submit', 'post', (option: any) => {
...
//删除数据
Mock.mock('https://www.demo.com/station/delete', 'post', (option: any) => {
  const res = JSON.parse(option.body)
  console.log('删除数据ID：', res)
  return {
    code: 200,
    msg: '删除成功',
    data: {
...
//充电桩列表接口
Mock.mock('https://www.demo.com/currentList', 'get', () => {
  return {
    code: 200,
    success: true,
    data: chargingPile,
...
Mock.mock('https://www.demo.com/submitMap', 'post', (option: any) => {
  const { name, address, immdia, content } = JSON.parse(option.body)
  console.log('新增站点：' + name, address, immdia, content)
  return {
    code: 200,
    success: true,
    msg: '新增站点成功！',
...
//删除所选记录
Mock.mock('https://www.demo.com/orderList/delete', 'post', (option: any) => {
  const res = JSON.parse(option.body)
  console.log('删除数据ID：', res)
  return {
    code: 200,
...
//计费管理 提交时间节点
Mock.mock('https://www.demo.com/addDot', 'post', (option) => {
  const res = JSON.parse(option.body)
  console.log(res.target + '新增规则：', res)
  return {
    code: 200,
    msg: '添加规则成功',
  }
...
Mock.mock('https://www.demo.com/alarm/select', 'post', (option: any) => {
  const level = JSON.parse(option.body)
  const selectedList = alarmList.filter((item) => item.level === level)
  return {
    code: 200,
    message: '操作成功',
    data: selectedList,
      ...
      [`list|${pageSize}`]: [
        {
          ...
          'department|1': ['总裁', '蓝室', '黑室', '离心', '浮力', '火发'], //所属部门
...
Mock.mock('https://www.demo.com/userAuth', 'post', (req: any) => {
  ...
  return {
    ...
    data: {
      list:
        pageAuthority == 'user' ? userMenulist : pageAuthority == 'manager' ? menulist2 : menulist,
      btn:
        pageAuthority == 'user'
          ? ['add']
